...
def test_cli_does_not_export_nonexistent_chat_or_refactor_commands() -> None:
...
def test_gen_command(
    mock_agent_class: Any, mock_llm_class: Any, mock_env: Any, tmp_path: Any
) -> None:
    """Test gen command."""
...
@patch("pig_coding_agent.cli.LLM")
@patch("pig_coding_agent.cli.CodingAgent")
def test_gen_command_with_output(
    mock_agent_class: Any, mock_llm_class: Any, mock_env: Any, tmp_path: Any
) -> None:
...
def test_analyze_command_missing_file(mock_env: Any) -> None:
...
def test_main_without_api_key(mock_ctx: Any) -> None:
...
def test_main_with_custom_model(
    mock_agent_class: Any, mock_llm_class: Any, mock_env: Any, mock_ctx: Any
) -> None:
...
@patch("pig_coding_agent.cli.LLM")
@patch("pig_coding_agent.cli.CodingAgent")
def test_main_with_workspace(
    mock_agent_class: Any, mock_llm_class: Any, mock_env: Any, mock_ctx: Any, tmp_path: Any
) -> None:
...
def test_run_json_mode_emits_shutdown_reason() -> None:
...
def test_run_json_mode_emits_interrupt_shutdown_reason() -> None:
...
def test_run_json_mode_emits_extension_shutdown_event_on_eof() -> None:
...
def test_run_json_mode_emits_extension_shutdown_event_on_interrupt() -> None:
...
def test_run_json_mode_cleans_up_extensions_on_shutdown() -> None:
...
def test_run_json_mode_piped_input_emits_shutdown_reason_and_cleanup(monkeypatch: Any) -> None:
...
def test_run_json_mode_piped_input_emits_error_shutdown_reason(monkeypatch: Any) -> None:
...
def test_run_json_mode_piped_input_emits_interrupt_shutdown_reason(monkeypatch: Any) -> None:
...
def test_main_installs_signal_cleanup_for_interactive_mode(
    mock_env: Any, mock_ctx: Any, tmp_path: Any
) -> None:
...
def test_available_cleanup_signals_skips_missing_sighup(monkeypatch: Any) -> None:
...
def test_run_with_signal_cleanup_prefers_protocol_shutdown_callback() -> None:
    ...
    with (
        ...
        try:
            cli._run_with_signal_cleanup(agent, trigger_sigterm)
        except SystemExit:
            pass
