...
{messages_html}
        ...
        <div class="footer">
            Generated by pig-mono | <a href="https://github.com/kangkona/pig-mono">GitHub</a>
        </div>
    </div>
</body>
</html>
"""
    ...
    @staticmethod
    def export_to_html(
        session: Session, output_path: Path | None = None, title: str | None = None
    ) -> Path:
    ...
    @staticmethod
    def export_to_markdown(session: Session, output_path: Path | None = None) -> Path:
