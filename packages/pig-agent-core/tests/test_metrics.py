...
class TestToolMetrics:
    ...
    def test_to_dict_with_inf_min_duration(self) -> None:
...
class TestToolMetricsCollector:
    ...
    def test_record_multiple_tools(self) -> None:
        ...
        search_metrics = collector.get_metrics("search_web")
        read_metrics = collector.get_metrics("read_file")
        assert search_metrics is not None
        assert read_metrics is not None
        assert search_metrics.total_calls == 2
        assert read_metrics.total_calls == 1
    ...
    def test_get_metrics_nonexistent_tool(self) -> None:
    ...
    def test_get_user_metrics_all_tools(self) -> None:
    ...
    def test_get_user_metrics_nonexistent_user(self) -> None:
        """Test getting metrics for nonexistent user."""
        collector = ToolMetricsCollector()
        assert collector.get_user_metrics("nonexistent") == {}

    def test_get_top_tools_by_calls(self) -> None:
    ...
    def test_get_top_tools_by_duration(self) -> None:
    ...
    def test_get_top_tools_by_failures(self) -> None:
    ...
    def test_get_top_tools_invalid_criterion(self) -> None:
