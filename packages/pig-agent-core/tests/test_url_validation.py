...
class TestValidateURL:
    ...
    def test_block_private_10_x(self) -> None:
...
class TestValidateRedirectURL:
    ...
    def test_block_redirect_to_localhost(self) -> None:
    ...
    def test_block_redirect_to_private_ip(self) -> None:
    ...
    def test_block_redirect_to_metadata(self) -> None:
    ...
    def test_allow_redirect_with_flag(self) -> None:
    ...
    def test_redirect_to_different_domain(self) -> None:
        """Test redirect to different public domain."""
        original = "https://example.com"
        redirect = "https://cdn.example.net/resource"
        assert validate_redirect_url(original, redirect) == redirect

    def test_redirect_with_path_change(self) -> None:
...
class TestURLValidationEdgeCases:
    ...
    def test_mixed_case_localhost(self) -> None:
